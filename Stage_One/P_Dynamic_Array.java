...
// OOP_Car demonstrates operation of infomation of cars;
...
//Outer class Link control relatively simple judgement tasks.

class Link{
	
	//Inner class Link control relatively advanced judgement tasks.
	private class Node{
		private Car data;
		private Node next;

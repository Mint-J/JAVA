...
// then write the compressed version to the array. At the end, the position of the write head will be 
// the length of the answer that was written.
...
// when we are at the last character, or when the next character is different from the current character.
